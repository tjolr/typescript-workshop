...
/**
 * OPPGAVE: legg til to generiske argumenter til transformasjonen
 * som representerer input og output
 *
 */
const opprettTransformasjon = <unknown, unknown>(
  transformasjon: Transformasjon<unknown, unknown>,
): Transformasjon<unknown, unknown> => {
